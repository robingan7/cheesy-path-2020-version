...
function init() {
	document.getElementById('select_pattern').value = '';
...
function addPoint() {
	...
	$("tbody").append("<tr>"
		...
		+ "<td><input value='" + (inverseEditY(prev.y+20))+"'></td>"
		+"<td><input value='0'></td>"
...
function update() {
	...
	$('tbody').children('tr').each(function () {
		...
		var y = editY(parseInt( $($($(this).children()).children()[1]).val() ));
